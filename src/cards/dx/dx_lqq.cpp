...
bool Card_dx_lqq_xueqifanggang::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_xueqifanggang::name, Card_dx_lqq_xueqifanggang::create);
/*
...
bool Card_dx_lqq_qianjinzhui::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_qianjinzhui::name, Card_dx_lqq_qianjinzhui::create);
/*
6/9/12攻，随机减1层负面状态
*/
...
bool Card_dx_lqq_pokongzhua::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_pokongzhua::name, Card_dx_lqq_pokongzhua::create);
/*
...
bool Card_dx_lqq_zhaoqipengbo::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_zhaoqipengbo::name, Card_dx_lqq_zhaoqipengbo::create);
/*
...
bool Card_dx_lqq_qishi::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_qishi::name, Card_dx_lqq_qishi::create);
/*
2/5/8攻，灵气+1，气势+2
*/
...
bool Card_dx_lqq_luochapu::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_luochapu::name, Card_dx_lqq_luochapu::create);
...
bool Card_dx_lqq_baoqifa::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_baoqifa::name, Card_dx_lqq_baoqifa::create);
...
bool Card_dx_lqq_pishanzhang::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_pishanzhang::name, Card_dx_lqq_pishanzhang::create);
...
bool Card_dx_lqq_duanquan::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_duanquan::name, Card_dx_lqq_duanquan::create);
...
bool Card_dx_lqq_bengquan_tan::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_bengquan_tan::name, Card_dx_lqq_bengquan_tan::create);
...
bool Card_dx_lqq_bengquan_feng::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_bengquan_feng::name, Card_dx_lqq_bengquan_feng::create);
/*
...
bool Card_dx_lqq_bengquan_chuo::registered = BaseCard::registerCard(FILE_CARDS_SOVJ, FILE_CARDS_REALM, Card_dx_lqq_bengquan_chuo::name, Card_dx_lqq_bengquan_chuo::create);
/*
